 ...
 * Description:       Add an off-canvas mobile menu for your Genesis child theme. Activate the plugin, then select the mobile menu location in Appearance -> Menus -> Menu Settings.
 * Version:           1.0.0
 * Author:            Tim Jensen
